...
\begin{itemize}
    \item Although compounds 681 and 889 did not reproduce hydrogen bonds with Gln711, Arg752, Asn705, or Thr877 \cite{pereira2006comparison}, both formed predicted $\pi$--$\pi$ interactions with Trp741 and adopted poses broadly similar to the co-crystallised ligand ENM \cite{cantin2007structural}.
     ...
     \item Docking scores needs to be interpreted cautiously, as they are model-dependent estimates rather than direct measures of binding affinity. Visual assessment of pose orientation, overlap with ENM, and ligand--receptor interactions was therefore considered more informative than docking score alone when prioritising compounds \cite{errington2025assessing,fischer2021decision}.
